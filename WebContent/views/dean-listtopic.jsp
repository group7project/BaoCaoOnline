                                ...
                                <table class="table table_list table-striped table-hover" id = "results">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class ="col-md-6">Tên đề tài</th>
                                            <th class ="col-md-3">Trạng thái</th>
                                            <th class="col-md-2 btn_float_righ">Chi tiết</th>
                                        </tr>
                                    </thead>
                                    <tbody id ="table_body">
                                    	<% int counter = 1; %>
                                        ...
                                        <tr>
                                           <th class ="col-md-1"><%= counter++ %></th>
                                            <td class ="col-md-6">${row.tenDeTai}</td>
                                            <td class ="col-md-3">${row.trangThai}</td>
                                            <td class ="col-md-2"><a href="dean_topic_detail.html?madt=${row.maDeTai}">Xem chi tiết</a></td>
                                        </tr>
                                        </c:forEach>
                                    </tbody>
                                    <tr>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body ">
                    <form data-toggle="validator" action="changpass.html?jspName=dean-listtopic.jsp" method="POST" class="form-horizontal" role="form">
