                                    ...
                                    <tbody>
                                    	...
                                    	<c:if test="${row != null}" >
	                                        <tr>
	                                            ...
	                                            <td>${row.maDeTai}</td>
	                                            <td>${row.tenDeTai}</td> 
	                                             <td><a href="downloadFileBaoCao?fileName=${row.filebaocao}&flag=2">${row.filebaocao}</a></td>
	                                            <td>${row.trangThai}</td> 
	                                            <td><a href="#dt-detail" data-target="#dt-detail" data-toggle="modal"
	                                            	data-tendetai="${row.tenDeTai}" data-svth ="${row.svths}"
    ...
    <div class="modal fade" id="password_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body ">
                    <form data-toggle="validator" action="changpass.html?jspName=GV_detaiPCPB.jsp" method="POST" class="form-horizontal" role="form">
                        <fieldset class="form-group">
