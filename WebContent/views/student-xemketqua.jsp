                    ...
                    <div class="panel-body">
                        <div class="panel panel-default" id="panel-default-nopbai">
                                    <div class="panel-body">
                                        ...
                                        <table class="table list-item table-hover">
                                                <thead style="background-color:#F0D4D4;">
                                                    <th class ="col-md-4" >Giảng viên</th>
                                                    <th  class ="col-md-2">Điểm</th>
                                                    <th class ="col-md-6">Nhận xét</th>
                                                </thead>
                                                <tbody>
                                                <c:choose>
	                                               	<c:when  test = "${detai.getTrangThai()=='Đã báo cáo'}">
		                                    			<c:forEach var="row" items="${detai_ketqua}">
		                                    			<c:if test="${row != null}" >
		                                                    <tr>
		                                                        <td class ="col-md-4">${row.getGv().hoTen}</td>
		                                                        <td class="col-md-2">${row.getDiem() }</td>
		                                                        <td class="col-md-6">${row.getNhanXet() }</td>
		                                                    </tr>
		                                                 </c:if>
		                                                  
		                                                  </c:forEach>
		                                                   <tr>
		                                                  <th class="col-md-4">Điểm trung bình:</th>
		                                                  <td class ="col-md-2">${detai.getDiem() }</td>
		                                                  </tr>
	                                                  </c:when >
	                                                  
	                                                  <c:otherwise>
	                                                  		<tr>
	                                                  		<td><h4>Đề tài chưa báo cáo!</h4></td>
	                                                  		</tr>
	                                                  </c:otherwise>
                                                  </c:choose>
                                                </tbody>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body ">
                    <form data-toggle="validator" action="changpass.html?jspName=student-xemketqua.jsp" method="POST" class="form-horizontal" role="form">
