...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-primary panel-fullheight">
                    <div class="panel-heading">
                        <h3 class="panel-title"> Danh sách sinh viên</h3>
                    </div>
                    <div class="panel-body">
                        <div class="panel panel-default panel_with_table">
                            ...
                            <div class="panel-body">
                                <table class="table table_list" id="results">
                                    ...
                                    <tbody>
                                    	<% int counter = 1; %>
                                    	<c:forEach var="row" items="${list_sv}">
                                        <tr>
                                                ...
                                                <div class="dropdown">
                                                  ...
                                                  <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                                    <li><a href="#edit-account-modal" data-target="#edit-account-modal" data-toggle="modal"
															data-masv = '${row.masv}' data-matkhau = "${row.matKhau}" 
															data-hoten = "${row.hoTen}" data-sdt = "${row.sdt}">Chỉnh sửa</a></li>
                          
                                                    <li><a href="deleteAccount.html?username=${row.masv}&role-name=SV">Xóa tài khoản</a></li>
                                                     <li role="separator" class="divider"></li>
                                                    <li><a href="blockAccount.html?username=${row.masv}&role-name=SV">Khóa tài khoản</a></li>
                                                    <li><a href="OpenAccount.html?username=${row.masv}&role-name=SV">Mở lại tài khoản</a></li>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body ">
                    <form data-toggle="validator" action="changpass.html?jspName=ad-student-manager.jsp" method="POST" class="form-horizontal" role="form">
    ...
    <div class="modal fade" id="edit-account-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="updateSinhVien.html" method="POST" class="form-horizontal" role="form">
                        <fieldset class="form-group">
							<label for="" class="col-sm-3">Mã SV/User:</label>
							<div class="col-sm-9">
								<input readonly type="text" class="form-control input-sm" name ="ma-sv" id="input-masv">
							</div>
						</fieldset>
						<fieldset class="form-group">
							<label for="" class="col-sm-3">Họ tên:</label>
							<div class="col-sm-9">
								<input  type="text" class="form-control input-sm" name="hoten-sv" id="input-hoten" >
							</div>
						</fieldset>
                        <fieldset class="form-group">
							<label for="" class="col-sm-3">Mật khẩu:</label>
							<div class="col-sm-9">
								<input  type="text" class="form-control input-sm" name="matkhau-sv" id="input-matkhau" >
							</div>
						</fieldset>
                        <fieldset class="form-group">
							<label for="" class="col-sm-3">Số điện thoại:</label>
							<div class="col-sm-9">
								<input  type="text" class="form-control input-sm" name="sdt-sv" id="input-sdt" >
							</div>
						</fieldset>
						<div class="modal-footer">
		                    <button type="button" class="btn btn-default" data-dismiss="modal">Đóng</button>
    ...
    <script>
		$('#edit-account-modal').on('show.bs.modal', function (event) {
		  ...
		  var masv = a.data('masv') // Extract info from data-* attributes
