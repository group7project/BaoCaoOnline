    ...
    <div class="container-fluid">
        <div class="row">
                    ...
                    <div class="panel-body">
                        <div class="panel-group" id="accordion">
                            ...
                            <div class="panel panel-primary ">
                                <div class="panel-heading">
                                   <h4 class="panel-title">
                                        <a href="dean-listteach.html" data-toggle="collapse" data-parent="#accordion">Danh sách giảng viên</a> 
                                    </h4>
                                </div>
                            </div>
                            <div class="panel panel-default">
            ...
            <div class="col-md-9">
                <div class="panel panel-primary panel-fullheight">
                    <div class="panel-heading">
                        <h3 class="panel-title"> Danh sách Giảng viên </h3>
                    </div>
                    <div class="panel-body">
                        <div class="panel panel-default panel_with_table">
                            ...
                            <div class="panel-body">
                                ...
                                <table class="table table_list table-striped table-hover" id = "results">
                                    ...
                                    <tbody>
                                    	<% int counter = 1; %>
                                    	<c:forEach var="row" items="${list_gv_khoa}">
                                        <tr>
                                            <th class="col-md-1"><%=counter++ %></th>
                                            <td class="col-md-3">${row.magv} </td>
                                            <td class="col-md-5">${row.hoTen}</td>
                                            <td class="col-md-3">${row.sdt}</td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body ">
                    <form data-toggle="validator" action="changpass.html?jspName=dean-listteach.jsp" method="POST" class="form-horizontal" role="form">
