        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-primary panel-fullheight" id="dsdt">
                    <div class="panel-heading">
                        <h3 class="panel-title">Xem báo cáo</h3>
                    </div>
                    <div class="panel-body">
                                ...
                                <table class="table table_list table-striped table-hover" id ="results">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class ="col-md-3">Thời điểm báo cáo</th>
                                            
                                            <th class = "col-md-3">Xem báo cáo</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    <% int counter = 1; %>
                                    	...
                                    	<c:if test="${row != null}" >
	                                        <tr>
	                                             <td scope="row" class ="col-md-1"><%= counter++ %></td>
	                                            <td class ="col-md-5">${row.tenDeTai}</td> 
	                                            <td class ="col-md-3">${row.gioBaoCao}</td> 
	                                            <td class ="col-md-3"><a href="gv_xembaocao.html?madetai=${row.maDeTai}" >Xem báo cáo</a></td>    
	                                        </tr>
                                        </c:if>
                                        </c:forEach>
                                    </tbody>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body ">
                    <form data-toggle="validator" action="changpass.html?jspName=GV_XemBC-PhanBien.jsp" method="POST" class="form-horizontal" role="form">
