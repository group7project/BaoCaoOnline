        ...
        <div class="row">
                    ...
                    <div class="panel-body">
                        <div class="panel-group" id="accordion">
                            ...
                            <div class="panel panel-default " id="panel_list">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a data-parent="#accordion" href="gv_trangchu.html?flag=3">Danh sách hội đồng</a>
                                    </h4>
                                </div>
                            </div>
            ...
            <div class="col-md-9">
                <div class="panel panel-primary panel-fullheight" id="dsdt">
                    <div class="panel-heading">
                        <h3 class="panel-title"> Danh sách đề tài được phân công làm Ủy viên Hội Đồng</h3>
                    </div>
                    <div class="panel-body">
                                    ...
                                    <tbody>
                                    	...
                                    	<c:if test="${row != null}" >
	                                        ...
	                                        <tr>
	                                            ...
	                                            <td>${row.maDeTai}</td>
	                                            <td>${row.tenDeTai}</td> 
	                                             <td><a href="downloadFileBaoCao?fileName=${row.filebaocao}&flag=3">${row.filebaocao}</a></td>
	                                            <td>${row.trangThai}</td> 
	                                            <td><a href="#dt-detail" data-target="#dt-detail" data-toggle="modal"
	                                            	...
	                                            	data-tgbctd="${row.tgbctd}">Chi tiết</a></td>  
	                                        </tr>
	                                        </c:if>
                                        </c:forEach>
    ...
    <div class="modal fade" id="password_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body ">
                    <form data-toggle="validator" action="changpass.html?jspName=GV_detaiPCUV.jsp" method="POST" class="form-horizontal" role="form">
                        <fieldset class="form-group">
