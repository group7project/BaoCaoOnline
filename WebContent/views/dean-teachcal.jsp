                        ...
                        <div class="panel-group" id="accordion">
                           <div class="panel-group" id="accordion">
                            <div class="panel panel-default ">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a href="dean_listtopic.html">Danh sách đề tài</a>
                                    </h4>
                                </div>
                            </div>
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a href="dean_listteach.html" data-toggle="collapse" data-parent="#accordion">Danh sách giảng viên</a>
                                    </h4>
                                </div>
                            </div>
                            <div class="panel panel-default">
                                ...
                                <table class="table table_list table-striped table-hover">
                                    ...
                                    <tbody id="table_body">
                                        <tr>
                                            ...
                                            <td class="col-md-2">DT1</td>
                                                <td class="col-md-4">Đề tài 1</td>
                                                    <td class="col-md-3">Đã xong</td>
                                                        <td class="col-md-3">Ủy viên</td>
                                        </tr>
                                        <tr>
                                            <th class="col-md-1">1</th>
                                            <td class="col-md-2">DT1</td>
                                                <td class="col-md-4">Đề tài 1</td>
                                                    <td class="col-md-3">Đang báo cáo</td>
                                                        <td class="col-md-3">Chủ tịch</td>
                                        </tr>
                                        <tr>
                                            <th class="col-md-1">1</th>
                                            <td class="col-md-2">DT1</td>
                                                <td class="col-md-4">Đề tài 1</td>
                                                    <td class="col-md-3">Đang chờ</td>
                                                        <td class="col-md-3">Chủ tịch</td>
                                        </tr>
                                        <tr>
                                            <th class="col-md-1">1</th>
                                        ...
                                        <tr>
                                            <td class="col-md-1">1</th>
                                            <td class="col-md-2">DT1</td>
                                                <td class="col-md-4">Đề tài 1</td>
                                                    <td class="col-md-3">Đã xong</td>
                                                        <td class="col-md-3">Phản biện</td>
                                        </tr>
                                        <tr>
                                            <th class="col-md-1">1</th>
                                            <td class="col-md-2">DT1</td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body ">
                    <form data-toggle="validator" action="changpass.html?jspName=dean-teachcal.jsp" method="POST" class="form-horizontal" role="form">
